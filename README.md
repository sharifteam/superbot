...
**An advance and powerful Administration bot based on [yagop/telegram-bot](https://github.com/yagop/telegram-bot)
# Features
...
cd $HOME
git clone https://github.com/sharifteam/sharifbot2.git
cd sharifbot2
chmod +x launch.sh
./launch.sh install
